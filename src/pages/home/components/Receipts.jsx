          ...
          <tbody>
            {receiptStore.data?.map((receipt, index) => (
              <tr key={Date.now() * Math.random()}>
                ...
                <td scope="col">
                  <div className="tableContent">{receipt.receipt_code}</div>
                </td>
                <td scope="col">
                ...
                <td scope="col">
                  <div className="tableContent">{receipt.pay_mode}</div>
                </td>
                <td scope="col">
                  <div className="tableContent">{receipt.update_at}</div>
                </td>
                <td scope="col">
                  <div className="tableContent">
                    <button
                      onClick={() => {
                        setShowDetail(true);
                        setPopData(receipt.receipt_details);
                      }}
                      type="button"
